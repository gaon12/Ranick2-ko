function check_update() {
	let current_version = "1.3.2"; // 현재 버전은 auto_run_script.js 최상단에도 있습니다.
	if (current_version == latest_version) {
		let timerInterval;
		Swal.fire({
			icon: "success",
			title: no_update_available,
			html: no_update_available_text1 + current_version + no_update_available_text2 + no_update_available_text3,
			timer: 5000,
